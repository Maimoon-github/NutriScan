    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      >
        <div>
          ...
          <p className="text-gray-700">Tap to view analysis</p>
        </div>
        <svg
                ...
                <div className="space-y-2">
                  {citations.map((citation, idx) => (
                    <div key={idx} className="p-3 bg-gray-50 rounded text-sm">
                      ...
                      <p className="text-gray-600 text-xs mt-1">{citation.source}</p>
                      {citation.excerpt && (
                        <p className="text-gray-700 mt-2">{citation.excerpt}</p>
                      )}
                      {citation.url && (
                        <a className="text-blue-600 text-xs mt-1 inline-block" href={citation.url} target="_blank" rel="noreferrer">
                          Open source
                        </a>
                      )}
                    </div>
